...
/**
 * Package: uk.ac.shef.wit.simmetrics.similaritymetrics.chapmanmeanlength Description: chapmanmeanlength implements a simple mean length
 * metric, i.e. strings of the similar lengths are more similar regardless of the content.
 * 
 ...
 * @version 1.2
 */
public final class ChapmanMeanLength implements SimilarityMetric {
	...
	public double getSimilarity( final String str1 , final String str2 ) {
		final float bothLengths = str2.length() + str1.length();
