...
/**
 * Package: costfunctions Description: SubCost1_Minus2 implements a substitution cost function where d(i,j) = 1 if i does not equal j, -2 if
 * i equals j.
 * <p>
 ...
 * @version 1.1
 */
public final class SubCost1_Minus2 implements InterfaceSubstitutionCost , Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = 1187255778695225273L;
