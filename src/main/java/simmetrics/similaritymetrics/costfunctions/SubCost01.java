...
/**
 * Package: costfunctions Description: SubCost01 implements a substitution cost function where d(i,j) = 1 if idoes not equal j, 0 if i
 * equals j.
 * <p>
 ...
 * @version 1.1
 */
final public class SubCost01 implements InterfaceSubstitutionCost , Serializable {
