...
/**
 * Package: costfunctions Description: InterfaceSubstitutionCost is an interface for a cost function d(i,j). Date: 24-Mar-2004 Time:
 * 13:26:21
 *
...
public interface InterfaceSubstitutionCost {
	 ...
	 */
	default String getShortDescriptionString() {
		return "";
	}
