...
public final class ChapmanLengthDeviation implements SimilarityMetric {

	public double getSimilarity( String str1 , String str2 ) {
		return str1.length() >= str2.length() ? ( float ) str2.length() / ( float ) str1.length() : ( float ) str1.length() / ( float ) str2.length();
	}
}
