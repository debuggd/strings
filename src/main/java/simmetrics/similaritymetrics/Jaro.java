...
/**
 * Package: uk.ac.shef.wit.simmetrics.similaritymetrics.jaro Description: uk.ac.shef.wit.simmetrics.similaritymetrics.jaro implements the
 * Jaro String Metric.
 * <p/>
 ...
 * @version 1.1
 */
public final class Jaro implements SimilarityMetric {
	...
	public float getSimilarityTimingEstimated( final String string1 , final String string2 ) {
		...
		// 0 0.18 0.35 0.75 1.32 2.01 2.96 3.9 5.07 6.34 8.12 9.23 11.94 12.69 15.69 16.92 20.3 22.56 27.38 27.25 40.8 33.83 40.6 40.6 54.75
		// 46.8 62.5 54.75 73 67.67 78 73 101.5 83.33 117 109.5 117.5 109 125 117.5 140.5 148.5 132.5 156.5 148.5 172 164 179.5 187.5 203
		// 211 203 203 250 235 265 250 282 297 281
	...
	public double getSimilarity( final String str1 , final String str2 ) {
		...
		final int halflen = ( ( Math.min( str1.length() , str2.length() ) ) / 2 ) + ( ( Math.min( str1.length() , str2.length() ) ) % 2 );

		// get common characters
		final StringBuffer common1 = getCommonCharacters( str1 , str2 , halflen );
		final StringBuffer common2 = getCommonCharacters( str2 , str1 , halflen );
		...
		return ( common1.length() / ( ( float ) str1.length() ) +
	...
	/**
	 * returns a string buffer of characters from string1 within string2 if they are of a given distance seperation from the position in
	 * string1.
	 *
	 * @param string1
	 * @param string2
	 * @param distanceSep
	 * @return a string buffer of characters from string1 within string2 if they are of a given distance seperation from the position in
	 *         string1
	 */
